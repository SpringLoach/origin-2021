...
- [优购商城项目](#优购商城项目)
  ...
  + [首页](#首页)
    - [首页搜索框](#首页搜索框)
    - [获取轮播图数据&网络请求](#获取轮播图数据&网络请求)
    - [封装请求](#封装请求)
    - [分类导航](#分类导航)
    - [楼层](#楼层)
  + [分类](#分类)
    - [接收分类数据](#接收分类数据)
    - [初构页面&两栏可滚动布局](#初构页面&两栏可滚动布局)
    - [渲染滚动区域](#渲染滚动区域)
    - [使用缓存技术](#使用缓存技术)
    - [右侧列表置顶](#右侧列表置顶)
    - [优化接口](#优化接口)
  + [商品分类](#商品分类)
    - [携带循环项参数跳转页面](#携带循环项参数跳转页面)
    - [实现tabs组件](#实现tabs组件)
    - [静态样式](#静态样式)
    - [动态渲染](#动态渲染)
    - [触底加载下一页](#触底加载下一页)
    - [下拉刷新](#下拉刷新)
    - [全局配置请求的加载图标效果](#全局配置请求的加载图标效果)  
  + [商品详情](#商品详情)
    - [商品详情_获取数据](#商品详情_获取数据)
    - [商品详情_渲染轮播图](#商品详情_渲染轮播图)
    - [商品详情_页面渲染](#商品详情_页面渲染)
    - [商品详情_获取数据优化](#商品详情_获取数据优化)
    - [商品详情_预览图片](#商品详情_预览图片)
    - [商品详情_底部工具栏](#商品详情_底部工具栏)
    - [加入购物车](#加入购物车)
  + [购物车](#购物车)
    - [购物车_获取地址](#购物车_获取地址)
    - [购物车_获取地址和具体地址的切换渲染](#购物车_获取地址和具体地址的切换渲染)
    - [购物车_布局及样式](#购物车_布局及样式)
    - [购物车_数据动态渲染](#购物车_数据动态渲染)
    - [购物车_数据处理](#购物车_数据处理)
    - [购物车_结算判断](#购物车_结算判断)
  + [支付页面](#支付页面)
    - [支付页面_布局](#支付页面_布局)
