...
isPrototypeOf(*object*) | 判断对象是否为参数对象的原型 | 布尔值
...
Object.getOwnPropertyNames(person) | 返回实例的所有属性 | 数组
Object.keys(person) | 返回实例自身可枚举的属性 | 数组
...
方法 | 说明 | 返回值 | 版本
:- | :-: | :-: | :-: 
Object.getOwnPropertyDescriptor(object) | 取得所有属性的描述符 | 配置对象 | ES2017
